 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,     KC_A,   KC_S,    KC_D,    KC_F,    LT(_LOWER,KC_G),                         LT(_LOWER,KC_H), KC_J,  KC_K,     KC_L,    KC_SCLN,  KC_QUOT,
...
[_RAISE] = LAYOUT(
  ...
  _______, _______, KC_PIPE, KC_PLUS, KC_LPRN, KC_RPRN,                      KC_PGUP, KC_HOME,   KC_UP,  KC_END, _______, KC_PLUS,
  _______, _______, KC_AMPR,  KC_EQL, KC_LCBR, KC_RCBR,                      KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_COLN, KC_DQT,
  _______, _______, KC_UNDS, KC_MINS, KC_LBRC, KC_RBRC,  KC_DEL,    _______, _______, _______, KC_LABK, KC_RABK, KC_QUES, KC_PIPE,
